...
- **や**: A particle meaning "and" (among others).
...
```
- You can include more nouns connected by **や** before adding **など**.
### Breakdown
...
#### とか (toka)
- **Usage**: Similar to **や**, but more casual and often used when giving examples or possibilities.
- **Example**: 
  - **りんごとかバナナを買いました。**
...
## 5. Cultural Notes
### Cultural Relevance
- **Indirect Communication**: Japanese culture often favors indirectness and implies information rather than stating it directly. Using **や** and **など** aligns with this communication style by suggesting there are more items without explicitly listing them.
