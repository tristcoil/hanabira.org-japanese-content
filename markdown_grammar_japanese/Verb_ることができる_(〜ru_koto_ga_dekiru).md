...
### Conjugation of できる
The verb **できる** is an **Ichidan verb (る-verb)** and is conjugated as follows:
| **Form**                     | **Conjugation** | **Polite Form**      | **English**            |
|------------------------------|-----------------|----------------------|------------------------|
| **Present Affirmative**      | できる          | できます             | Can do                 |
| **Present Negative**         | できない        | できません           | Cannot do              |
| **Past Affirmative**         | できた          | できました           | Could do               |
| **Past Negative**            | できなかった    | できませんでした     | Could not do           |
---
