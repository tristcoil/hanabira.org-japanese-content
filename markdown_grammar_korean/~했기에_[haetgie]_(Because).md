...
### Structure
The structure for forming sentences with **~했기에** is as follows:
**Verb Stem + 았/었기에**
- **Verb Stem**: Base form of the verb without the final 다.
- **았/었**: Past tense marker.
  - Use **았** after verb stems ending with vowels **ㅏ** or **ㅗ**.
...
1. **Incorrect Tense Usage**
   ...
   - Correct: *갔기에*
   *Remember to apply the past tense marker **았/었** before **기에** when indicating past reasons.*
...
### Quick Recap Quiz
1. How do you form **~했기에** with the verb **읽다** (to read)?
   **Answer**: **읽었기에** (읽 + 었 + 기에)
2. Choose the correct form to complete the sentence:
   **비가 많이 ________ 행사가 취소되었습니다.**
...
3. Is **~했기에** more formal or casual?
