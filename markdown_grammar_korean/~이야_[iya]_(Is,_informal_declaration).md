...
1. Which ending would you use after the noun **학교** (school)?
   ...
   **Correction:** Actually, **학교** ends with a vowel sound, but the final consonant is 'yo', but this is a common confusion.
   Let's correct this.
   **학교** ends with '교', which is a vowel ending, so we use **~야**.
