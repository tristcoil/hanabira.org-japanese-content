...
- **If the verb stem ends in a consonant**: add **-을 때마다**
  - Example: 먹다 (to eat) → 먹**을 때마다**
- **If the verb stem ends in a vowel**: add **-ㄹ 때마다**
  - Example: 가다 (to go) → 가**ㄹ 때마다**
---
...
### Learning Strategies
- **Mnemonic Device**: Remember that **때** means **"time"** in Korean. So, **~할 때마다** literally translates to **"each time when [I] do"**.
...
|-----------------|------------|-----------------------------|------------------------|
| 가다 (to go)    | 가         | Vowel                       | 갈 때마다              |
| 먹다 (to eat)   | 먹        | Consonant                   | 먹을 때마다            |
| 배우다 (to learn)| 배우      | Vowel                       | 배울 때마다            |
| 듣다 (to listen)| 듣        | Consonant                   | 들을 때마다            |
---
## Practice Exercise
